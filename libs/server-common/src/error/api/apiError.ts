...
const STANDARD_API_ERRORS_LIST: ApiErrorBase[] = [
    ...
    },
    {
        ...
        helpUrl     : 'https://www.abf.gov.au/help-and-support/contact-us',
        helpText    : 'The permissions given to your API client id do not allow you to access the resource. '
    ...
    },
    {
        ...
        helpUrl     : 'https://www.abf.gov.au/help-and-support/contact-us',
        helpText    : 'The specified resource could not be found.  '
            + 'Please check that your security credentials are correct, '
            + 'and that you are attempting to access the correct resource.'
    },
    {
        id          : 'DVPAPI-005',
        code        : 'NotImplemented',
        detail      : 'The [{0}] method has not yet been implemented for the [{1}] resource.',
        helpUrl     : 'https://www.abf.gov.au/help-and-support/contact-us',
        helpText    : 'The specified method for the given resource has yet to be implemented.  '
    ...
    },
    {
        ...
        helpUrl     : 'https://www.abf.gov.au/help-and-support/contact-us',
        helpText    : 'A timeout occurred while attempting to invoke a web service. This may be a temporary '
...
class ApiError implements ApiErrorBase {
    ...
    public static fromId(id: string, ...args: string[]): ApiError {
        ...
        const standardError = STANDARD_API_ERRORS_LIST.filter(
            error => {
                return error.id === id;
            }
        );
