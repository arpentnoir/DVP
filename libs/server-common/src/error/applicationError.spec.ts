...
describe('ApplicationError', () => {
  ...
  it('should correctly format a "SystemError".', () => {
    const error: ApplicationError = new SystemError(
  ...
  it('should correctly format a "ValidationError".', () => {
    const error: ApplicationError = new ValidationError(
  ...
  it('should correctly format a "NotFoundError".', () => {
    const error: ApplicationError = new NotFoundError(
      '/flights/arrivals/c0c191b3-be3e-42f6-968c-625ed7223627'
    );
    expect(error).toBeDefined();
    expectError(
      error,
  ...
  it('should correctly format a "NotImplementedError".', () => {
    const error: ApplicationError = new NotImplementedError(
      '/flights/arrivals',
      'DELETE'
    );
    expect(error).toBeDefined();
  ...
  it('should correctly format a "AuthorizationError".', () => {
    ...
    const error2: ApplicationError = new AuthorizationError(
      '/flights/arrivals/1',
      'user1'
    );
    expect(error2).toBeDefined();
