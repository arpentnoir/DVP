...
export const CredentialsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} [cursor] Starting key for the result set. If you don\&#39;t pass a cursor parameter, but do pass a limit parameter, the default value retrieves the first portion (or \&quot;page\&quot;) of results.
         ...
         */
        getCredentials: async (cursor?: string, limit?: number, q?: string, sort?: 'asc' | 'desc', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const CredentialsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getCredentials(cursor?: string, limit?: number, q?: string, sort?: 'asc' | 'desc', options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CredentialsResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getCredentials(cursor, limit, q, sort, options);
...
export const CredentialsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getCredentials(cursor?: string, limit?: number, q?: string, sort?: 'asc' | 'desc', options?: any): AxiosPromise<CredentialsResponse> {
            return localVarFp.getCredentials(cursor, limit, q, sort, options).then((request) => request(axios, basePath));
        },
        /**
         * Issues a credential and returns it in the response body.
         * @summary Issues a credential and returns it in the response body.
...
export interface CredentialsApiInterface {
     ...
     */
    getCredentials(cursor?: string, limit?: number, q?: string, sort?: 'asc' | 'desc', options?: AxiosRequestConfig): AxiosPromise<CredentialsResponse>;
...
export class CredentialsApi extends BaseAPI implements CredentialsApiInterface {
     ...
     */
    public getCredentials(cursor?: string, limit?: number, q?: string, sort?: 'asc' | 'desc', options?: AxiosRequestConfig) {
        return CredentialsApiFp(this.configuration).getCredentials(cursor, limit, q, sort, options).then((request) => request(this.axios, this.basePath));
    }
