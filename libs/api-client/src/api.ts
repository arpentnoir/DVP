...
export const CredentialsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getRevocationList: async (statusId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'statusId' is not null or undefined
            assertParamExists('getRevocationList', 'statusId', statusId)
            const localVarPath = `/status/{statusId}`
...
export const CredentialsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getRevocationList(statusId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetRevocationList200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getRevocationList(statusId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Issues a credential and returns it in the response body.
...
export const CredentialsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getRevocationList(statusId: number, options?: any): AxiosPromise<GetRevocationList200Response> {
            return localVarFp.getRevocationList(statusId, options).then((request) => request(axios, basePath));
        },
        /**
         * Issues a credential and returns it in the response body.
         * @summary Issues a credential and returns it in the response body.
...
export interface CredentialsApiInterface {
     ...
     * @memberof CredentialsApiInterface
     */
    getRevocationList(statusId: number, options?: AxiosRequestConfig): AxiosPromise<GetRevocationList200Response>;
...
export class CredentialsApi extends BaseAPI implements CredentialsApiInterface {
    ...
    public getRevocationList(statusId: number, options?: AxiosRequestConfig) {
        return CredentialsApiFp(this.configuration).getRevocationList(statusId, options).then((request) => request(this.axios, this.basePath));
    }
