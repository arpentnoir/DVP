...
import { dvpVpcPrivateSubnetIds } from "./vpc";
...
const schemaRegistryDocumentDbSubnetGroup = new aws.docdb.SubnetGroup(
  ...
  {
    description: "subnet group for schemaRegistryDocumentDbCluster. Refers to `dvpVpcPrivateSubnetIds`.",
    name: `${stack}-schema-registry-documentdb-subnet-group`,
    subnetIds: dvpVpcPrivateSubnetIds,
    tags: {
      Name: `${stack}-schema-registry-documentdb-subnet-group`,
    },
  }
